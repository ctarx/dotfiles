...
hl.monitor({ output = "DP-1", mode = "2560x1440@143.97", position = "0x0", scale = omarchy_monitor_scale })

-- Portrait/rotated secondary monitor (transform: 1 = 90°, 3 = 270°).
-- hl.monitor({ output = "DP-2", mode = "preferred", position = "auto", scale = 1, transform = 1 })
hl.monitor({ output = "DP-2", mode = "preferred", position = "auto-right", scale = omarchy_monitor_scale })
